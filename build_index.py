...
SOURCES = [
    ...
    {"marca": "Daniel Smith", "tipo": "Acuarela", "archivo": "daniel_smith_acuarela_convertido.xlsx",
     "fiabilidad": 5, "fuente": "Daniel Smith Official (danielsmith.com - CIE Lab Coordinates + Pigment Characteristics)"},
]
